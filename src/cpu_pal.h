            ...
            (((u64) (state.pcr & state.pcen)) << 29) |                                                         \
              (((u64) (state.sir & state.sien)) << 13) |                                                       \
                (                                                                                              \
                  (                                                                                            \
                    (u64)                                                                                      \
                      (((U64(0x1) << (state.cm + 1)) - 1) & state.aster & state.astrr & (state.asten * 0x3))   \
                  ) << 3                                                                                       \
                ) |                                                                                            \
                  (                                                                                            \
                    (                                                                                          \
                      (u64)                                                                                    \
                        (((U64(0x1) << (state.cm + 1)) - 1) & state.aster & state.astrr & (state.asten * 0xc)) \
                    ) << 7                                                                                     \
                  );                                                                                           \
      break;                                                                                                   \
                                                                                                          \
...
#define DO_HW_LDQ   switch(function)                                          \
  {                                                                           \
...
#define DO_HW_STL   switch(function)                                          \
  {                                                                           \
  case 0:       /* longword physical */                                       \
    phys_address = state.r[REG_2] + DISP_12;                                  \
    ...
    {                                                                         \
      ...
      {                                                                       \
        ...
        {                                                                     \
          ...
          { dram_write(dram_ptr, phys_address, 32, state.r[REG_1]); state.r[REG_1] = 1; } \
        }                                                                     \
        else                                                                  \
...
#define DO_HW_STQ   switch(function)                                           \
  {                                                                            \
  case 1:       /* quadword physical */                                        \
    phys_address = state.r[REG_2] + DISP_12;                                   \
    ...
    {                                                                          \
      ...
      {                                                                        \
        ...
        {                                                                      \
          ...
          { dram_write(dram_ptr, phys_address, 64, state.r[REG_1]); state.r[REG_1] = 1; } \
        }                                                                      \
        else                                                                   \
